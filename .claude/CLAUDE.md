...
├── docs/
│   ├── lld/iam-lld-delegation-service.md  # the full LLD v2.10 (design-time source of truth)
...
- **`CONTRIBUTING.md`** — dev setup, extension playbooks, PR checklist
- **`VERSIONING.md`** — SemVer policy, runtime-contract scope, release process, compatibility matrix
- **`docs/lld/iam-lld-delegation-service.md`** — the full Low-Level Design (v2.10) this service implements
