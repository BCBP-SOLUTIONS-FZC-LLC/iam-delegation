...
│   └── eventschema/                   # 7 hand-maintained JSON Schemas: 4 published (delegation_{started,ended,review_requested,escalation_requested}.json) + 3 consumed (membership_revoked.json, tenant_memberships_purged.json, user_updated.json); no extract-schemas step (DLG-D20)
...
├── docs/
│   ├── lld/                           # LLD, current rev 2.18 — design-time source of truth; as-built decisions DLG-D48/D49 in ARCHITECTURE.md
